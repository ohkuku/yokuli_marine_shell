...
object DesktopLayoutEditor {
    fun resize(
        ...
        val entry = entries.firstOrNull { it.id == current.entryId } ?: return null
        val cycle = entry.supportedSizesInCycleOrder
    ...
    fun unpin(document: DesktopDocument, tileId: TileId): LayoutTransaction? {
