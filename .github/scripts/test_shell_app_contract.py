...
class ShellAppTileContractTest(unittest.TestCase):
    ...
    def test_each_feature_owns_its_tile_content(self):
        ...
        self.assertIn("MarineTileSize.ICON_1X1 to LauncherTileRenderer", chart)
        ...
        self.assertIn('testTag("preferences-tile-small")', preferences)
        self.assertIn('testTag("preferences-tile-medium")', preferences)
        self.assertNotIn('testTag("preferences-tile-wide")', preferences)
