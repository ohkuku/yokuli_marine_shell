...
for captured_step in ci-helpers launcher-stage0-contract nmea-sources-p7-contract chart-library-cl07-contract chart-library-cl10-contract chart-library-cl11-contract chart-library-cl12-contract osr-w01-contract osr-w02-contract osr-w03-contract google-maps-evidence unit-tests lint assemble; do
