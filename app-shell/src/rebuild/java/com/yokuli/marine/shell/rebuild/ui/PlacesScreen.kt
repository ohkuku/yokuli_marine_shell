            ...
            PageBody {
                when(page) {
                    0 -> {
                        ...
                        if(navigating && os.activeRoute?.points!=route.points)Label(os.t("收藏已编辑。本次导航继续使用出发时的路线。","Saved plan edited. This navigation keeps the route used at departure."),16,c.muted)
