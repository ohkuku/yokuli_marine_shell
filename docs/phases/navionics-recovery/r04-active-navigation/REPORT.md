...
NAVREF-R04 now makes active-route replacement explicit and atomic across Chart and Navigation. A pending proposal is shared through the one OS-owned snapshot; cancellation leaves the current passage untouched, and confirmation replaces it only after durable persistence succeeds. CI and real APK acceptance remain pending.
