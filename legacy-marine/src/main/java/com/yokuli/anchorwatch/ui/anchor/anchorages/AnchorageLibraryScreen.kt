...
fun AnchorageLibraryScreen(
    ...
    BackHandler(showFilters||showRegions||showQrScanner||showEditor||detailMapOpen||state.selectedPlace!=null){
        when { showEditor->showEditor=false; showQrScanner->showQrScanner=false; detailMapOpen->detailMapOpen=false; showFilters->showFilters=false; showRegions->showRegions=false; else->vm.selectPlace(null) }
    }
