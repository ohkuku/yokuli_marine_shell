...
import com.yokuli.anchorwatch.di.MarineIntegrationEntryPoint
 ...
 */
object LegacyMarineRuntime {
    fun initialize(application: Application) {
        val incidentLogger = EntryPointAccessors.fromApplication(application, MarineIntegrationEntryPoint::class.java).incidentLogger()
